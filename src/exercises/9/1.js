    ...
    puppeteer.launch({ headless: false }).then(async (browser) => {
        await browser.newPage()
            .then(async (page) => {
                ...
                page.goto('C:/Users/USER/Documents/apxor/apps/FrontEndExercises/src/exercises/1/insert.html');
                ...
                browser.newPage().then(async (page) => {
                    page.goto('C:/Users/USER/Documents/apxor/apps/FrontEndExercises/src/exercises/1/1.html');
                    await delay(delayInterval);
